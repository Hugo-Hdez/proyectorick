...
import 'package:proyectorick/providers/api_provider.dart';
...
class CharacterScreen extends StatelessWidget {
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  carData("Estado", character.status),
                  carData("Especie", character.species),
                  carData("Origen", character.origin.name),
                ],
              ),
            ),
            const Text(
  ...
  Widget carData(String text1, String text2){
    return Expanded(
      child: Card(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.center,
